...
SKETCH_NAME="electronic_safe"
TMP_DIR=".tmp_arduino_buildsrc/$SKETCH_NAME"
...
mkdir -p "$TMP_DIR"
mkdir -p "$CLI_TMP_DIR"
cp ./*.ino ./*.cpp ./*.h "$TMP_DIR/"
mv "$TMP_DIR/electronic-safe.ino" "$TMP_DIR/$SKETCH_NAME.ino"
...
echo "Build completed: build/$SKETCH_NAME.ino.hex"
